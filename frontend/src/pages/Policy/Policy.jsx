...
Sharing of Personal Data for Plus Membership Benefits and Partner Services:
...
export default function Policy() {
  ...
  return (
    <div className="policy-container" ref={containerRef} tabIndex={0}>
      ...
      <div className="policy-content">
        {termsText.split('\n\n').map((paragraph, index) => {
          // Check if paragraph is a heading (shorter text without periods at the end)
          const isHeading = paragraph.trim().length > 0 && 
                           paragraph.trim().length < 100 && 
                           !paragraph.trim().endsWith('.') &&
                           !paragraph.trim().startsWith('Disclaimer:') &&
                           !paragraph.trim().startsWith('We ') &&
                           !paragraph.trim().startsWith('While ') &&
                           !paragraph.trim().startsWith('When ') &&
                           !paragraph.trim().startsWith('If ') &&
                           !paragraph.trim().startsWith('For ') &&
                           !paragraph.trim().startsWith('In ') &&
                           !paragraph.trim().startsWith('Additionally') &&
                           !paragraph.trim().startsWith('Mr ') &&
                           !paragraph.trim().startsWith('Email:') &&
                           !paragraph.trim().startsWith('You ') &&
                           !paragraph.trim().startsWith('Please ') &&
                           !paragraph.trim().startsWith('To ') &&
                           !paragraph.trim().startsWith('Most ') &&
                           !paragraph.trim().startsWith('Our ') &&
                           !paragraph.trim().startsWith('Last ');
          ...
          if (isHeading) {
            return (
              <h2 key={index} className="policy-heading">
                {paragraph.trim()}
              </h2>
            );
          }
